...
class HttpRequest implements MyHandlerMsg{
    ...
    HttpRequest(RequestBody requestBody, String key, Handler myHandler, Context context){
        this.requestBody = requestBody;
        this.myHandler = myHandler;
        this.key = key;
     ...
     */
    HttpRequest( String key, Handler myHandler, String cookie ){
        this.myHandler = myHandler;
        this.key = key;
        this.cookie = cookie;
