...
public class FoodActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        mItemLinearlayout = findViewById(R.id.menu_item_linearlayout);
        mItemGridlayout = findViewById(R.id.menu_item_gridlayout);
        mItemStaggeredlayout = findViewById(R.id.menu_item_staggeredlayout);
